...
def main(cfg: DictConfig) -> None:
    # Experiment name
    print(f"Model weight: '{cfg.paths.log_dir}{cfg.weight}'")
    ...
    # Model
    model_path = os.path.join(cfg.paths.log_dir, cfg.weight)
    ...
    # submission.csv로 저장
    submission.to_csv(
        f"../submission/{cfg.weight.split('/')[2]}_{cfg.weight.split('/')[3].split('.')[0]}.csv",
        index=False,
    )
